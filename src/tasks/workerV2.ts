...
task("workerV2:hire", "Hire and authorize a worker")
    .addOptionalParam(
        "accountIndex",
...
task("workerV2:acceptJob", "Accept a job (FOR TESTING ONLY")
    .addOptionalParam(
        "accountIndex",
        "Account index from MNEMONIC to use",
        0,
...
task("workerV2:authorize", "Authorize a worker")
    .addOptionalParam(
        "accountIndex",
        "Account index from MNEMONIC to use",
        0,
...
task("workerV2:show", "Show a worker information")
    .addOptionalParam(
        "accountIndex",
        "Account index from MNEMONIC to use",
        0,
